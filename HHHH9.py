...
original_map = [
    ...
    ["K","0","0","T","1","P","1","X","0","0","1","B","G","T","1"], 
    ["1","F","F","X","1","0","1","X","0","0","0","0","0","G","1"], 
    ["1","F","F","T","1","1","1","X","0","0","1","F","0","0","1"], 
    ["1","F","F","X","D","0","0","X","0","0","1","0","0","0","1"], 
    ["1","F","F","T","D","0","0","X","0","0","1","1","1","0","1"], 
    ["1","D","D","D","D","D","D","X","0","0","1","S","T","S","1"], 
    ["0","1","0","0","0","0","0","X","0","1","1","T","T","T","1"], 
    ["0","1","0","0","0","0","0","X","M","D","0","0","T","S","1"], 
    ["0","P","0","0","0","0","0","X","0","1","1","W","W","W","1"], 
    ["0","1","0","0","0","0","0","X","0","1","T","T","T","T","T"], 
    ["0","1","0","0","0","0","0","X","1","1","T","T","T","T","T"], 
    ["1","0","0","0","0","0","0","P","G","0","T","T","T","T","T"], 
    ["1","0","0","0","0","0","0","X","1","1","T","T","T","0","2"], 
...
def update_status_text(custom_msg=""):
    ...
    hp_text = f"HP: {max(0, player_hp)}/{MAX_PLAYER_HP}"
...
def check_game_status():
    ...
    if tile == "2":
        game_over = True
        if not check_final_epiphany():
            update_status_text("🏆 GODLIKE! HELL MODE CONQUERED!")
        return
...
def reset_game():
    ...
    game_over = False; player_hp = MAX_PLAYER_HP; freeze_duration = 0; room3_light_mode = 0
...
def check_final_epiphany():
    """最终关胜利时，以剩余生命值决定是否触发 Upload 结局。"""
    if game_over and player_hp > MAX_PLAYER_HP / 2:
        print("Green Block 不再寻找出口。")
        print("他明白，自己并没有被困在这里。")
        print("他成为了出口的一部分。")
        screen.bgcolor("#355c7d")
        update_status_text("✨ UPLOAD ENDING: He became part of the exit.")
        return True
    return False
